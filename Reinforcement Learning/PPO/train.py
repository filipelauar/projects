...
env, config, outdir, logger = init('./configs/config_random_lunar.yaml', "PPOAgentKLAdaptatif")
...
agent = PPOAgent_1(env, config) # PPOAgent_2(env, config)
...
mean_B = 0
mean_DKL = 0
logger.direct_write("Politique/B", agent.B, 0)
